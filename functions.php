...
function nodeExist($conn, $nid)
{
    ...
    $sql = "SELECT COUNT(*) FROM `frmn_node` WHERE `nid` = $nid";
...
function insertNode($row, $conn)
{
    ...
    $sql = "INSERT INTO `frmn_node`(`nid`, `vid`, `type`, `uuid`, `langcode`) 
    ...
    $sql = $conn->prepare("INSERT INTO `frmn_node__body`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `body_value`, `body_summary`, `body_format`) 
    ...
    // $sql = "INSERT INTO `frmn_node__comment`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `comment_status`)
    ...
    $sql = $conn->prepare("INSERT INTO `frmn_node_field_data`(`nid`, `vid`, `type`, `langcode`, `status`, `uid`, `title`, `created`, `changed`, `promote`, `sticky`, `default_langcode`, `revision_translation_affected`)
    ...
    $sql = $conn->prepare("INSERT INTO `frmn_node_field_revision`(`nid`, `vid`, `langcode`, `status`, `uid`, `title`, `created`, `changed`, `promote`, `sticky`, `default_langcode`, `revision_translation_affected`)
    ...
    $sql = "INSERT INTO `frmn_node_revision`(`nid`, `vid`, `langcode`, `revision_uid`, `revision_timestamp`, `revision_log`, `revision_default`)
     VALUES ('$row->nid','$row->vid','$row->language','$row->revision_uid','$row->revision_timestamp',null, 1)";
    $conn->exec($sql);
    echo "node_revision <br>";

    $sql = $conn->prepare("INSERT INTO  `frmn_node_revision__body`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `body_value`, `body_summary`, `body_format`)
    VALUES ('$row->type','0','$row->nid','$row->revision_uid','$row->language',0,:html,'$body->summary','basic_html')");
    $sql->bindParam('html', $html);
    $sql->execute();
    ...
    // $sql = "INSERT INTO `frmn_node_revision__comment`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `comment_status`) 
    //    VALUES ('$row->type',0,'$row->nid','$row->revision_uid','$row->language',0,'$row->comment')";
    // $conn->exec($sql);
...
function addActu($conn)
{
    ...
    $data = getData('data/article-p1.json');
    $index = 0;
    foreach ($data as $row) {
        if (nodeExist($conn, $row->nid)) {
            ...
            if (count($row->field_image->und) != 0) {
                ...
                $sql = "SELECT * FROM `frmn_file_managed` WHERE `uuid` = '$img->uuid'  LIMIT 1";
                ...
                if (!$obj) {
                    $sql = "INSERT INTO `frmn_file_managed`( `uuid`, `langcode`, `uid`, `filename`, `uri`, `filemime`, `filesize`, `status`, `created`, `changed`)
                    ...
                    $sql = "SELECT * FROM `frmn_file_managed` ORDER BY `fid` DESC LIMIT 1";
                    $result = $conn->prepare($sql);
                    $result->execute();
            ...
            $sql = "INSERT INTO `frmn_file_usage`(`fid`, `module`, `type`, `id`, `count`)
            ...
            // $sql = "INSERT INTO `frmn_node_revision__field_image`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_image_target_id`, `field_image_alt`, `field_image_title`, `field_image_width`, `field_image_height`) 
            ...
            if ($row->field_fichier != []) {
                ...
                if (count($row->field_fichier->und) != 0) {
                    ...
                    foreach ($row->field_fichier->und as $file) {
                        ...
                        $sql = "SELECT * FROM `frmn_file_managed` WHERE `uuid` = '$file->uuid'  LIMIT 1";
                        ...
                        $objf = $result->fetchObject();



                        if (!$objf) {

                            $sql = $conn->prepare("INSERT INTO `frmn_file_managed`( `uuid`, `langcode`, `uid`, `filename`, `uri`, `filemime`, `filesize`, `status`, `created`, `changed`)
                            ...
                            $sql = "SELECT `fid` FROM `frmn_file_managed` ORDER BY `fid` DESC LIMIT 1";
                        ...
                        $sql = "INSERT INTO `frmn_node__field_fichier`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`,`field_fichier_target_id`, `field_fichier_display`, `field_fichier_description`) 
...

{
    ...
    $data = getData('data/ranking.json');
    ...
    foreach ($data as $row) {
        ...
        if (nodeExist($conn, $row->nid)) {
         ...
         VALUES ('$row->type',0,'$row->nid','$row->revision_uid','$row->language',0,'$tid')";
            ...
            $sql = "INSERT INTO `frmn_node__field_jour`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_jour_value`)
         ...
         VALUES ('$row->type',0,'$row->nid','$row->revision_uid','$row->language',0,'$day')";
            ...
            $sql = "INSERT INTO `frmn_node__field_mois`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_mois_value`)
          ...
          VALUES ('$row->type',0,'$row->nid','$row->revision_uid','$row->language',0,'$mois')";
            ...
            $sql = "INSERT INTO `frmn_node__field_event_addresse`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_event_addresse_value`)
          ...
          VALUES ('$row->type',0,'$row->nid','$row->revision_uid','$row->language',0,'$add')";
            ...
            $sql = "INSERT INTO `frmn_node__field_ville`(`bundle`, `deleted`, `entity_id`, `revision_id`, `langcode`, `delta`, `field_ville_value`)
...
function addGalleries($conn)

{



    $data = getData('data/gnew.json');
